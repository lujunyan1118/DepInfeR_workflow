...
```{r supp_arcTrans, fig.height=3, fig.width=5}
...
```{r targetNet_GDSC, fig.height=5, fig.width=5}

#define interesting targets
CancerxTargets <- c("DDR1", "BCR", "ABL1", "EGFR", "PDGFRB", "MET", "FLT3" , "PTK2", "INPPL1", "PAK4",  "MAP2K2", "MAPK10")
